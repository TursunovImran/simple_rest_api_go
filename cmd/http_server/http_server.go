...
func createNoteHandler(w http.ResponseWriter, r *http.Request) {
	log.Print("CALLED CREATE NOTE FUNC")
	info := &NoteInfo{}
...
func getNoteHandler(w http.ResponseWriter, r *http.Request) {
	log.Print("CALLED GET NOTE FUNC")
	noteID := chi.URLParam(r, "id")
	fmt.Printf("In GET NOTE request has been received this id: %v", noteID)
	id, err := parseNoteID(noteID)
	fmt.Printf("In GET NOTE request has been received this id: %d", id)
	if err != nil {
